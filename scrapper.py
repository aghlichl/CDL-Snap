...
#     url = "https://api.github.com/repos/aghlichl/CDL-Snap/contents/data/statistics.json"
...
#         {"sha": sha1, "message": "updated stats through GitHub API", "content": content})
...
#         ]
#     }
#     headers = ['Name', 'Pos', 'Age', 'Tm', 'G', 'GS', 'MP', 'FG', 'FGA', 'FG%', '3P', '3PA', '3P%', '2P',
...
#                 curr_player_name = strip_accents(player_stats[i].text)
#             else:
...
#                 'name': player_stats[i].text, "img": "<img id='cover-img' src='https://cdn.nba.com/headshots/nba/latest/260x190/{}.png' />".format(img_url_code)}
#         else:
#             nba_hash[(player_stats[(i-(i % 29))].text)
#                      ][headers[(i % 29)]] = (player_stats[i].text)
